...
####
# As a first step, I collected my code from the jupyter notebook where I experimented with different models.
# I also organized the code into functions, which are the starting point for writing the train and predict
# pipelines in the REST application (here app.py and MLPersist.py). 
####
